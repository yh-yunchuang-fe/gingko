...
export default () => {
    ...
    const onChangeIconRadio = (data: any) => {
        setState({
            ...state,
            baiduStyle: data ? {
                color: '#FE8F1D',
    ...
    return <View style={style.radioContainer}>
        ...
        <WhiteSpace />
        <Radio
            style={{...style.radioWrap, ...state.checkedStyle}}
        ...
        <Radio
            ...
            dir='right'
            icon={({ checked }) => {
                return checked && <Icon name='checkmark' />
            }}
            style={{
                backgroundColor: '#fff',
                padding: 10,
        ...
        <RadioGroup
            mode='button'
            options={['飞行中', '已落地', '已落地', '已落地']}
        />
        <WhiteSpace/>
        <WhiteSpace/>
        <RadioGroup
            mode='button'
            options={['飞行中(12)', '已落地(0)']}
        />
        <WhiteSpace/>
        <WhiteSpace/>
        <RadioGroup
