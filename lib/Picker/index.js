    ...
    constructor() {
        ...
        this.renderCols = () => {
            ...
            if (Array.isArray(data)) {
                return data.map((group, idx) => {
                    return (isAndroid ?
                        React.createElement(Picker_android_1.default, { key: idx }, this.renderItems(group)) : React.createElement(react_native_1.Picker, { key: idx }, this.renderItems(group)));
                });
            }
            return null;
        };
        ...
        this.renderPicker = () => {
            ...
            if (children) {
                ...
                return (isAndroid ? React.createElement(Picker_android_1.default, Object.assign({}, rest, { itemStyle: react_native_1.StyleSheet.flatten(itemSty), style: react_native_1.StyleSheet.flatten([style, columnSty]), onValueChange: this.onChange, selectedValue: this.state.value }), children) : React.createElement(react_native_1.Picker, Object.assign({}, rest, { itemStyle: react_native_1.StyleSheet.flatten(itemSty), style: react_native_1.StyleSheet.flatten([style, columnSty]), onValueChange: this.onChange, selectedValue: this.state.value }), children));
            }
