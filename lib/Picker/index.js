...
class default_1 extends React.Component {
    constructor() {
        ...
        this.renderItems = (group) => {
            return group.map(({ label, value }, idx) => {
                if (label === undefined || label === null) {
                    return (<react_native_1.Picker.Item label={String(value)} value={value} key={idx}/>);
                }
                return (<react_native_1.Picker.Item label={String(label)} value={value} key={idx}/>);
            });
        };
        this.renderCols = () => {
        ...
        this.renderPicker = () => {
            ...
            const _a = this.props, { value, children, style, itemStyle, columnStyle } = _a, rest = __rest(_a, ["value", "children", "style", "itemStyle", "columnStyle"]);
            if (children) {
