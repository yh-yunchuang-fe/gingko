...
class Picker extends react_1.default.Component {
    ...
    render() {
        ...
        const items = react_1.default.Children.map(children, (item, index) => {
            ...
            return (<react_native_1.View ref={(el) => this[`item${index}`] = el} onLayout={index === 0 ? this.onItemLayout : undefined} key={item.key}>
        ...
        return (<react_native_1.View style={style}>
                ...
                <react_native_1.View ref={(el) => this.indicatorRef = el} style={Picker_android_1.default.indicator} pointerEvents='box-none'/>
            </react_native_1.View>);
    }
}
