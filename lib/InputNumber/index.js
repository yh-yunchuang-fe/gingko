...
class InputNumber extends react_1.default.Component {
    ...
    render() {
        ...
        return (react_1.default.createElement(react_native_1.View, Object.assign({ style: [style_1.default.wrap, style, activeWrap, { width: width }] }, restProps),
            minusDom,
            react_1.default.createElement(react_native_1.TextInput, { style: [style_1.default.textInput, activeInput], value: stateValue + '', editable: inputEditable, autoFocus: autoFocus, underlineColorAndroid: "transparent", onChangeText: (text) => {
