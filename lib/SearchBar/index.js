...
class SearchBar extends react_1.default.Component {
    ...
    render() {
        ...
        return (<react_native_1.View style={index_1.default.wrapper}>
                <react_native_1.View style={index_1.default.inputWrapper}>
                ...
                {showCancel &&
                <react_native_1.Animated.View style={[index_1.default.cancel, slide]}>
                        <react_native_1.TouchableOpacity onPress={this.onCancel}>
                            <react_native_1.Text style={[index_1.default.cancelText, { color: cancelColor }]}>
                                {cancelText}
                            </react_native_1.Text>
                        </react_native_1.TouchableOpacity>
