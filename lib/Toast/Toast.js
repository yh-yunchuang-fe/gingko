...
class Toast extends react_1.default.Component {
    ...
    renderIcon() {
        ...
        if (type === 'loading') {
            return (<react_native_1.View style={style_1.default.iconContainer}>
                    <Indicator_1.default size={style_2.default.width_toast_withicon_icon}/>
                </react_native_1.View>);
        }
        let iconName = '';
        switch (type) {
        ...
        if (iconName) {
            this.ownIcon = true;
            return (<react_native_1.View style={style_1.default.iconContainer}>
                    <Icon_1.default name={iconName} color={style_2.default.color_toast_icon} size={style_2.default.width_toast_withicon_icon}/>
                </react_native_1.View>);
        }
    ...
    render() {
        ...
        return (<react_native_1.View style={[style_1.default.container, position === 'center' ? { justifyContent: 'center' } : {}]} pointerEvents={mask ? undefined : 'box-none'}>
