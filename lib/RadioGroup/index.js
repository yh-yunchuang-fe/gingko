...
class RadioGroup extends react_1.default.Component {
    ...
    render() {
        ...
        const dom = radios.map((item, index) => {
            ...
            return (<react_native_1.View style={cutLineSty} key={index}>
                    <react_native_1.TouchableOpacity onPress={this.onChange.bind(this, index, item)}>
                        <react_native_1.View style={[index_1.default.radioBtn, itemSty, activeSty]}>
                            <react_native_1.Text style={[index_1.default.radioBtnText, activeText]}>
                                {item}
                            </react_native_1.Text>
                        </react_native_1.View>
        ...
        return (<react_native_1.View style={[index_1.default.radioGroup, style]}>
                {dom}
            </react_native_1.View>);
    }
}
