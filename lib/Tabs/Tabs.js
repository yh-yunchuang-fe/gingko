...
class Tabs extends react_1.default.Component {
    ...
    renderTabBar(tabBarProps, renderTabBar) {
        if (renderTabBar) {
            ...
            return react_1.default.createElement(DefaultTabBar_1.default, Object.assign({}, tabBarProps));
        }
    }
    ...
    render() {
        ...
        return (react_1.default.createElement(react_native_1.View, { style: Object.assign({ flexDirection: this.isTabVertical() ? 'row' : 'column' }, style) },
            this.renderTabBar(tabBarProps, renderTabBar),
            react_1.default.createElement(react_native_1.View, { style: Object.assign({}, index_1.default.Tabs.content) }, this.renderContent())));
    }
}
