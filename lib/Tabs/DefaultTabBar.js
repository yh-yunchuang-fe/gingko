...
class DefaultTabBar extends react_1.default.Component {
    ...
    renderTab(tab, index) {
        ...
        return (<react_native_1.TouchableOpacity key={`${tab.title}_${index}`} onPress={() => this.onPress(index)}>
                <react_native_1.View style={Object.assign(Object.assign({}, index_1.default.TabBar.tab), { backgroundColor: bgColor })}>
                    {renderTab ? renderTab(tab, isTabActive) :
                <react_native_1.Text style={Object.assign(Object.assign({ color: textColor }, index_1.default.TabBar.textStyle), textStyle)}>
                                {tab.title}
                            </react_native_1.Text>}
                </react_native_1.View>
    ...
    render() {
        ...
        return (<react_native_1.View style={Object.assign(Object.assign({}, index_1.default.TabBar.container), { backgroundColor: tabBarFillColor || index_1.default.TabBar.fillColor })}>
                <react_native_1.ScrollView ref={(scrollView) => { this.scrollView = scrollView; }} horizontal={!this.isTabVertical()} showsHorizontalScrollIndicator={false} showsVerticalScrollIndicator={false} scrollsToTop={false}>
                    <react_native_1.View style={Object.assign(Object.assign({}, index_1.default.TabBar.tabs), { backgroundColor: tabBarFillColor || index_1.default.TabBar.fillColor })}>
                        {tabs.map((name, index) => {
                let tab = { title: name };
