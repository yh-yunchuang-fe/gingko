...
class DefaultTabBar extends react_1.default.Component {
    ...
    renderTab(tab, index) {
        ...
        return (react_1.default.createElement(react_native_1.TouchableOpacity, { key: `${tab.title}_${index}`, onPress: () => this.onPress(index) },
            react_1.default.createElement(react_native_1.View, { style: Object.assign(Object.assign({}, index_1.default.TabBar.tab), { backgroundColor: bgColor }) }, renderTab ? renderTab(tab, isTabActive) :
                react_1.default.createElement(react_native_1.Text, { style: Object.assign(Object.assign({ color: textColor }, index_1.default.TabBar.textStyle), textStyle) }, tab.title))));
    }
    render() {
        const { tabs, tabBarFillColor, } = this.props;
        return (react_1.default.createElement(react_native_1.View, { style: Object.assign(Object.assign({}, index_1.default.TabBar.container), { backgroundColor: tabBarFillColor || index_1.default.TabBar.fillColor }) },
            react_1.default.createElement(react_native_1.ScrollView, { ref: (scrollView) => { this._scrollView = scrollView; }, horizontal: !this.isTabVertical(), showsHorizontalScrollIndicator: false, showsVerticalScrollIndicator: false, scrollsToTop: false },
                react_1.default.createElement(react_native_1.View, { style: Object.assign(Object.assign({}, index_1.default.TabBar.tabs), { backgroundColor: tabBarFillColor || index_1.default.TabBar.fillColor }) }, tabs.map((name, index) => {
                    let tab = { title: name };
