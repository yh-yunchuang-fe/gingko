...
class Grid extends react_1.default.Component {
    ...
    render() {
            ...
            for (let j = 0; j < columnNum; j++) {
                ...
                if (index < dataLength) {
                    ...
                    arr.push(react_1.default.createElement(react_native_1.TouchableOpacity, { key: j, style: [
                            ...
                            flexItemStyle,
                            itemStyle
                        ], onPress: () => onClick && onClick(paramItem, index) }, this.renderItem(item, index)));
                }
                else {
        ...
        return (react_1.default.createElement(react_native_1.View, { style: [index_1.default.gridContainer, { paddingHorizontal: blankWidth }] }, rowsArr));
    }
}
Grid.defaultProps = {
    data: [],
