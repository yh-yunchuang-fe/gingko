...
const rn_topview_1 = __importDefault(require("rn-topview"));
...
function a(title, content, actions = [{ text: '确定' }]) {
    const onAnimationEnd = (visible) => {
        if (!visible) {
            rn_topview_1.default.remove();
        }
    };
    rn_topview_1.default.set(react_1.default.createElement(Alert, { title: title, content: content, actions: actions, onAnimationEnd: onAnimationEnd }));
}
exports.default = a;
