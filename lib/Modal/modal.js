    ...
    render() {
        ...
        if (footer && footer.length) {
            if (footer.length === 1) {
                ...
                footerDom = (<react_native_1.View style={[style_1.default.btnGroup, style_1.default.singleBtn]}>
                        <Button_1.default {...restProps} type={newType} style={Object.assign({ width: variables_1.default.modal_single_btn_width }, style)} onClick={onPressFn}>{text}</Button_1.default>
                    </react_native_1.View>);
            }
            if (footer.length === 2) {
                const buttons = footer.map((button, idx) => {
                    ...
                    return (<Button_1.default {...restProps} type={type} key={idx} style={Object.assign({ width: variables_1.default.modal_group_btn_width }, style)} onClick={onPressFn}>{text}</Button_1.default>);
                });
        ...
        return (<Dialog_1.default visible={visible} onClose={onClose} {...restProps}>
                <react_native_1.View style={[style_1.default.container, style]}>
                    ...
                    <react_native_1.View style={[style_1.default.body, bodyStyle]}>
                        {children}
                    </react_native_1.View>
                    {footerDom}
                </react_native_1.View>
