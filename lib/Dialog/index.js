...
class Dialog extends react_1.default.Component {
    ...
    render() {
        ...
        return (react_1.default.createElement(react_native_1.Modal, { visible: true, transparent: transparent, onRequestClose: onClose },
            react_1.default.createElement(react_native_1.View, { style: [style_1.default.wrap, wrapStyle] },
                react_1.default.createElement(react_native_1.TouchableWithoutFeedback, { onPress: this.onMaskClose.bind(this) },
                    react_1.default.createElement(react_native_1.Animated.View, { style: [style_1.default.absolute, { opacity: this.state.opacity }] },
                        react_1.default.createElement(react_native_1.View, { style: [style_1.default.absolute, maskStyle] }))),
                react_1.default.createElement(react_native_1.Animated.View, { style: [style, animationStyleMap[animationType]] }, children))));
    }
}
Dialog.defaultProps = {
    style: {},
