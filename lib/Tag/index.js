...
class Tag extends react_1.default.Component {
    ...
    render() {
        ...
        const textSizeSty = index_1.default[`text${size}Sty`];
        if (readonly) {
            return (<react_native_1.View style={index_1.default.wrap}>
                    <react_native_1.View style={[index_1.default.content, sty, style]} {...restProps}>
                        <react_native_1.Text style={[index_1.default.text, textSizeSty, textSty, textStyle]}>
                            {children}
                        </react_native_1.Text>
                    </react_native_1.View>
                </react_native_1.View>);
            ...
            return (<react_native_1.View style={index_1.default.wrap}>
                    <react_native_1.TouchableWithoutFeedback onPress={this.onClick}>
                        <react_native_1.View style={[index_1.default.content, sty, style]} {...restProps}>
                            <react_native_1.Text style={[index_1.default.text, textSizeSty, textSty, textStyle]}>
                                {children}
                            </react_native_1.Text>
