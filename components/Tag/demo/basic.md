    ...
    <WingBlank>
      <View style={styles.tagWrap}>
        <View style={styles.tagList}>
          <Tag color="orange" fill>
            标签
          </Tag>
          <Tag color="orange">标签</Tag>
          <Tag color="orange" font>
            标签
          </Tag>
        </View>
        ...
        <View style={styles.tagList}>
          <Tag color="green" fill>
            标签
          </Tag>
          <Tag color="green">标签</Tag>
          <Tag color="green" font>
            标签
          </Tag>
        </View>
      ...
      <View style={styles.tagListWrap}>
        <Tag color="#FE8F1D" fill size="sm">
          标签
        </Tag>
        <Tag color="#FE8F1D" fill>
          标签
        </Tag>
        <Tag color="#FE8F1D" fill size="lg">
          标签
        </Tag>
      </View>
      <WhiteSpace />
      ...
      <View style={styles.tagListWrap}>
        <Tag size="lg" readonly={false} style={styles.tagItem}>
          模版一
        </Tag>
        <Tag size="lg" readonly={false} style={styles.tagItem}>
          模版二
      ...
      <Tag fill color="#E7F7FF" textColor="#24A8E8">
        已报障，等待维修
      </Tag>
      <WhiteSpace />
      <Tag
